        ...
        <div className="bento-card p-10 relative overflow-hidden group">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-4 rounded-xl bg-white text-gray-900 font-display font-bold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
