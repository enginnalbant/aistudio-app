  ...
  return (
    <div className="space-y-8 pb-20 h-full pr-2">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 relative">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-text-secondary font-medium text-lg tracking-tight opacity-70">Rapor operasyonel zekasını yönetin.</p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-20 opacity-20">
        ...
        <p className="text-xl font-display font-bold text-skel-metal uppercase tracking-widest">Rapor Dashboard Boş</p>
      </div>
    </div>
  );
}
