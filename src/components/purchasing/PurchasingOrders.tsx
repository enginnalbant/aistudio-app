...
import { PurchasingOrdersWizard } from './PurchasingOrdersWizard';
...
export function PurchasingOrders() {
  ...
  const stats = [
    ...
    { 
      ...
      trend: '%92 başarı oranı',
      trendType: 'up'
    },
    { 
      label: 'Toplam Tutar', 
      value: `${orders.reduce((sum, o) => sum + o.items.reduce((s: number, i: any) => s + (i.qty * i.price), 0), 0).toLocaleString('tr-TR')} ₺`, 
      icon: TrendingUp, 
      color: 'bg-blue-50 text-blue-600',
      trend: 'Bütçe dahilinde',
      trendType: 'up'
    }
  ];
    ...
    <div className="p-8 space-y-8 bg-slate-50/50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 font-medium text-lg">Tedarikçilere verilen siparişleri takip edin ve yönetin.</p>
        </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 text-sm text-slate-500 font-medium">
                      ...
                      <span className="flex items-center gap-1.5"><Clock size={16} /> {new Date(order.date).toLocaleDateString('tr-TR')}</span>
